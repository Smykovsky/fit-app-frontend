  ...
  <div class='nav-container' v-bind:class="{ active: $store.getters['store/getMenuIsActive'] }">
    <nav>
      <ul>
        ...
        <li @click='logout' class='dashboard-li'>
        ...
        <li v-if='isAdmin' class='dashboard-li admin'>
          <router-link class="text-decoration-none" :to="{name: 'admin'}">
            <font-awesome-icon class='icon' icon="fa-solid fa-user" />
